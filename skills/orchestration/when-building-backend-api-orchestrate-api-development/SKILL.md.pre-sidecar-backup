...
x-tags:
  - general
x-author: system
x-verix-description: [assert|neutral] Use when building a production-ready REST API from requirements through deployment. Orchestrates 8-12 specialist agents across 5 phases using Test-Driven Development methodology. Covers planning, arch [ground:given] [conf:0.95] [state:confirmed]
---
